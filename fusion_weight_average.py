...
parser.add_argument("--outf", type=str, default="Fusion_Weights", help='path of log files')
...
def main():
    ...
    data = h5py.File('/home/seamus20/matlab_wyl/Train_Dataset/VISION_train_new_nat_40_50_2810850.mat', 'r')# new
...
#NEW TRAINING
        ...
        if (epoch + 1) % 1 == 0:
            torch.save(module_fusion.state_dict(),os.path.join(opt.outf, f'conv7-se_1*1-epoch{epoch + 1}.pth'))
        ...
        if OUR_prnu_auc > max_AUC:
            ...
            moudle_name = 'conv7-se_1*1' + '_' + str(epoch + 1) + '_' + str(max_AUC) + '.pth'
    ...
    torch.save(module_fusion.state_dict(), os.path.join(opt.outf, 'conv7-se_1*1.pth'))
