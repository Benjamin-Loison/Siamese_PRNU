...
if __name__ == '__main__':
    ...
    Proposed_rep = sio.loadmat('SCORE_SAVE_Dresden_REP/Dresden_FUSION_64_REP_scores_all.mat')
    ...
    OUR_rep_fpr, OUR_rep_tpr, OUR_rep_auc = ROC_prefcurve(Proposed_rep)
    ...
    plt.plot(OUR_rep_fpr, OUR_rep_tpr, color='green', linestyle=':', label='PROPOSED_REP (AUC = {:.4f})'.format(OUR_rep_auc),
             linewidth=1.5, marker='D', markersize=4.0, markevery=1000)
    plt.plot(OUR_fpr, OUR_tpr, color='red', label='PROPOSED_PCE (AUC = {:.4f})'.format(OUR_auc),
    ...
    plt.savefig(
        'Dresden_ROC_IMAGE_svg/Rep_Dresden_16k_ROC_Curve_{}x{}.svg'.format(B, B),
        dpi=2000,
        bbox_inches='tight'
    )
