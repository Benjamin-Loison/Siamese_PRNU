...
class dataset_prnu_positive(data.Dataset):
    """
    # -----------------------------------------
    ...
    def __init__(self):
        super(dataset_prnu_positive, self).__init__()
        ...
        data = h5py.File('Dresden_test/Dresdentest_positive_PRNU-IMAGES_128_256.mat', 'r')  # 正例、128*128、256patch dresden prnu_image
