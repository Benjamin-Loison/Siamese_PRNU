...
def main():
    ...
    data = h5py.File('/home/seamus20/matlab_wyl/Train_Dataset/VISION_train_new_nat_large_40_50_2810850.mat', 'r')# new
...
#init_validate_dataset
    ...
    for epoch in rangeepochs:
        ...
        if (epoch + 1) % 1 == 0:
            torch.save(module_fusion.state_dict(),os.path.join(opt.outf, f'weight_average_wiener_nat-epoch{epoch + 1}.pth'))
        ...
        if OUR_prnu_auc > max_AUC:
            ...
            moudle_name = 'weight_average-wiener_nat' + '_' + str(epoch + 1) + '_' + str(max_AUC) + '.pth'
    ...
    torch.save(module_fusion.state_dict(), os.path.join(opt.outf, 'weight_average-wiener_nat.pth'))
