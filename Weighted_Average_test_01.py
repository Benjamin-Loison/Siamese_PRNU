...
#negative_fusion
    ...
    save_folder = "PCE_SAVE_Dresden_Surround_conv7+se"
    if not os.path.exists(save_folder):
        os.makedirs(save_folder)
# #保存权重用于后续ROC曲线绘制
    save_path = os.path.join(save_folder, 'Dresden_PRNU-nowiener-center_160_pce_values_lower-left.mat')
    sio.savemat(save_path, {'positive_pce': pos_pce_values,'negative_pce': neg_pce_values})

    save_path = os.path.join(save_folder, 'Dresden_FUSION-nat-nowiener-center-160_pce_values_lower-left.mat')
