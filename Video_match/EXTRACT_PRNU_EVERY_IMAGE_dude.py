...
def main():
    ...
    save_dir = '/home/seamus20/matlab_wyl/Dresden_every_image_npy_40cameras'
    ...
    for Camera_dir_name in Cameras_dir_sorted:
            ...
            for image_file in jpg_files:
                ...
                prnu, image_name = PRNU_Extract_pinjie(module_dncnn, image_file)
                end_time = time.time()
