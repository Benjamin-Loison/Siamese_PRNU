...
def myshow(file_result=''):
    ...
    for i in range(len(dev_list)):
        for j in range(len(score_mat[i])):
            ...
            count += 1
    Acs = Acs/count
    logger.info('Acs score: %5.5f' % Acs)
    ...
    logger.info('avg_time: '+str(avg_time))
    ...
    logger.info('Accuracy score: %5.5f' % skl_acc)
    ...
    logger.info('AUC=%5.3f' % auc)

if __name__ == '__main__':
    myshow(file_result = '/home/seamus20/z_Project/Video_match/SDI_Cross/output_Eff_repB0_shift/results_test1.npz')