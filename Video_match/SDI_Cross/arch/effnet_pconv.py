...
from SDI_Cross.arch.layers import SEModule
...
class EfficientNet_pconv(nn.Module):
...
if __name__ == "__main__":
    ...
    net = EfficientNet_pconv(width_coeff=1.1, depth_coeff=1.2, dropout_rate=0.2, drop_connect_rate=0.3)
