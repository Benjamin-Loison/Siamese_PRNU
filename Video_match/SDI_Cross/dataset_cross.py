...
from SDI_Cross.utility_dataset import to_categorical
from SDI_Cross.SCIFunctions.crosscorr2 import crosscorr2
from SDI_Cross.utility_dataset import preprocessing_function
...
class DataGenerator(Dataset):
    def __init__(self, batch_size, list_data0, list_data1,
        ...
        self.num_blocks = int(num_blocks)  # 18
        self.to_categorical = int(to_categorical)  # 2
        self.batch_size = int(batch_size)  # 72
        self.num_combine = self.size_block * self.num_blocks  # 36
        self.list_data0 = list_data0
        self.list_data1 = list_data1
        self.num_classes = len(self.list_data0)  # 36
