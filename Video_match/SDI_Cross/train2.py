...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_size', type=int, default=720)  # minim um size of the image
    parser.add_argument('--crop_size', type=int, default=80)  # size of the central patch, to be cropped
    parser.add_argument('--random_cropping', type=int, default=40)  # 40 pixel for random cropping during training
    parser.add_argument('--model_dir', type=str, default='./weight_Eff_repB0/Pixle_80')  # directory with CNN weights
    ...
    train_data_generator = DataGenerator(config.batch_size_train, train_prnu, train_data,
                                                   ...
                                                   preprocessing_function1=None, random_crop=True,
