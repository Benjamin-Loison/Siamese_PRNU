...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_dir', type=str, default='./weight_Eff_repB0/Pixle_256_256')  # directory with CNN weights
    parser.add_argument('--output_file', type=str, default='./output_Eff_repB0_shift/results_256_256_re.npz')  # output file with result
