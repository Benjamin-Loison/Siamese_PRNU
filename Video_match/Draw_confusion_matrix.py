...
def myshow(file_result=''):
    ...
    # 传入cmap参数
    plot_confusion_matrix(cm=cm, classes=dev_labels, cmap='GnBu')
    ...
    plt.xlabel('预测设备', fontproperties='SimHei')
    plt.ylabel('真实设备', fontproperties='SimHei')
    ...
    plt.savefig('confusion_matrix_shift30.svg', format='svg', bbox_inches='tight')
    plt.show()
    print('AUC=%5.3f' % auc)
