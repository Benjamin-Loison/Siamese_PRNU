...
from utility_dataset_new import load_prnu, load_res
...
if __name__ == '__main__':
    ...
    def_dev_list = 'D03_Huawei_P9;D04_LG_D290;D05_Apple_iPhone5c;D06_Apple_iPhone6;D07_Lenovo_P70A;D08_Samsung_GalaxyTab3;' \
    ...
    parser.add_argument('--image_size', type=int, default=64)  # minimum size of the image
    parser.add_argument('--crop_size', type=int, default=64) # size of central patch
    parser.add_argument('--output_file', type=str, default='./output_Pce/results-vision_64_64-dwt.npz')  # output file with result
