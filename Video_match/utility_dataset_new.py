...
vision_dev_list = 'D03_Huawei_P9;D04_LG_D290;D05_Apple_iPhone5c;D06_Apple_iPhone6;D07_Lenovo_P70A;D08_Samsung_GalaxyTab3;' \
...
# # # #PRNU_fusion
vision_prnu_dir = '/home/seamus20/matlab_wyl/VISION_PRNU_FUSION_npy/%s.npy'
# dresden_prnu_dir = '/home/seamus20/matlab_wyl/Dresden_PRNU_FUSION_npy/%s.npy'
...
# # PRNU_dwt_50
# vision_prnu_dir = '/home/seamus20/matlab_wyl/VISION_PRNU_DWT_npy/%s.npy'
# dresden_prnu_dir = '/home/seamus20/matlab_wyl/Dresden_prnu_6camera/%s.npy'
#
# # PRNU_dwt
# vision_prnu_dir = 'SDI_Cross/VISION_PRNU_npy/%s.npy'
# dresden_prnu_dir = 'SDI_Cross/Dresden_PRNU_npy/%s.npy'
...
def load_res(list_noises, size=None, dtype=np.float32):
    ...
    for index, filename in tqdm(enumerate(list_noises)):
        ...
        if shape_img is None:
            ...
            if size is not None:
                crop_frame[0] = ((res.shape[0] - size) // 2)+0
                crop_frame[1] = ((res.shape[1] - size) // 2)+0
