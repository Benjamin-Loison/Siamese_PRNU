...
if __name__ == '__main__':
    ...
    parser.add_argument('--crop_size', type=int, default=140)  # size of the central patch, to be cropped
    parser.add_argument('--random_cropping', type=int, default=40)  # 40 pixel for random cropping during training
    parser.add_argument('--model_dir', type=str, default='./weight_Eff_repB0_dresden/Pixle_256_140-fusion')  # directory with CNN weights -101为cross2 -201为cross 601wei dresden
    ...
    train_data_generator = DataGenerator(config.batch_size_train, train_prnu, train_data,
                                                   ...
                                                   preprocessing_function1=preprocessing_function, random_crop=False,
