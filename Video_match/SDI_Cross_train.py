...
if __name__ == '__main__':
    ...
    def_dev_list_train ='D02_Apple_iPhone4s;D03_Huawei_P9;D04_LG_D290;D05_Apple_iPhone5c;D06_Apple_iPhone6;D07_Lenovo_P70A;D08_Samsung_GalaxyTab3;' \
                         ...
                         'Praktica_DCZ5.9_0;Praktica_DCZ5.9_1;Praktica_DCZ5.9_2;Praktica_DCZ5.9_3;Praktica_DCZ5.9_4;Olympus_mju_1050SW_0;Olympus_mju_1050SW_1'
    def_dev_list_valid = 'D02_Apple_iPhone4s;D03_Huawei_P9;D04_LG_D290;D05_Apple_iPhone5c;D06_Apple_iPhone6;D07_Lenovo_P70A;D08_Samsung_GalaxyTab3;' \
                         'D10_Apple_iPhone4s;D11_Samsung_GalaxyS3;D12_Sony_XperiaZ1Compact;D14_Apple_iPhone5c;D15_Apple_iPhone6;D16_Huawei_P9Lite;D17_Microsoft_Lumia640LTE;' \
                         'D20_Apple_iPadMini;D21_Wiko_Ridge4G;D22_Samsung_GalaxyTrendPlus;D23_Asus_Zenfone2Laser;D25_OnePlus_A3000;D27_Samsung_GalaxyS5;' \
                         'D28_Huawei_P8;D29_Apple_iPhone5;D30_Huawei_Honor5c;D31_Samsung_GalaxyS4Mini;D32_OnePlus_A3003;D33_Huawei_Ascend;D35_Samsung_GalaxyTabA;'\
                         'Praktica_DCZ5.9_0;Praktica_DCZ5.9_1;Praktica_DCZ5.9_2;Praktica_DCZ5.9_3;Praktica_DCZ5.9_4;Olympus_mju_1050SW_0;Olympus_mju_1050SW_1'
    ...
    parser.add_argument('--crop_size', type=int, default=180)  # size of the central patch, to be cropped
    parser.add_argument('--random_cropping', type=int, default=40)  # 40 pixel for random cropping during training
    parser.add_argument('--model_dir', type=str, default='./weight_Eff_repB0/Pixle_256_180-fusion')  # directory with CNN weights -101为cross2 -201为cross
    ...
    parser.add_argument('--batch_size_train', type=int, default=68)  # batch size in training 必须是相机的两倍
    parser.add_argument('--batch_size_valid', type=int, default=68)  # batch size in validation
    ...
    train_data = [load_res(np.load('/home/seamus20/matlab_wyl/Train_nat_path/train/%s.npy' % item).tolist(), config.image_size) for item in list_dev_train]
    ...
    valid_data = [load_res(np.load('/home/seamus20/matlab_wyl/Train_nat_path/valid/%s.npy' % item).tolist(), config.image_size) for item in
                  list_dev_valid]
