...
if __name__ == '__main__':
    ...
    def_dev_list ='D02_Apple_iPhone4s;D03_Huawei_P9;D04_LG_D290;D05_Apple_iPhone5c;D06_Apple_iPhone6;D07_Lenovo_P70A;D08_Samsung_GalaxyTab3;' \
    ...
    parser.add_argument('--crop_size', type=int, default=180) # size of central patch
    parser.add_argument('--model_dir', type=str, default='./weight_Eff_repB0/Pixle_256_180-fusion')  # directory with1 CNN weights
    parser.add_argument('--output_file', type=str, default='./output_Eff_repB0/results_256_180-fusion.npz')  # output file with result
...
#验证集和训练集上的正确率要测试一下
    ...
    # list_content = [np.load('/home/seamus20/matlab_wyl/Train_nat_path/test/%s.npy' % item).tolist() for item in list_dev]
