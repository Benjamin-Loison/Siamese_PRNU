...
def main():
    ...
    sio.savemat('Dresden_PCE_dict_128/SPN_PCE.mat', {'intra_pce': adnet_intra_pce, 'inter_pce': adnet_inter_pce})

    ADNet_PCE = sio.loadmat('Dresden_PCE_dict_128/SPN_PCE.mat')
