...
def main():
    ...
    data = h5py.File('data/VISION_distance_step=10_40_64_119168.mat', 'r')#小
    # data = h5py.File('data/VISION_train_step=10_mod10_40_64_205312.mat', 'r')#大
    ...
    if resume:
        ...
        # model.load_state_dict(torch.load('logs_nat/Siamese_mloss +_33_AUC=0.734177_AUC_prnu=0.972794.pth'))
    ...
    for epoch in rangeepochs:
        ...
        print("\n[epoch %d] AUC_prnu: %.6f" % (epoch + 1, OUR_prnu_auc))

        OUR_auc = round(OUR_auc, 6)
        OUR_prnu_auc = round(OUR_prnu_auc, 6)


        # # save model
        model_name = 'Siamese_mloss +' + '_' + str(epoch + 1) + '_AUC=' + str(OUR_auc)+ '_AUC_prnu=' + str(OUR_prnu_auc) + '.pth'
