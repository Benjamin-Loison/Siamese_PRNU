...
#test-dataset
    ...
    # data = h5py.File('Fusion_test_nowiener/DRESDEN_TEST_LARGE_POSITIVE-CENTER-nowiener64_1_4000.mat', 'r')  # large

    data = h5py.File('/home/seamus20/matlab_wyl/Fusion_test/DRESDEN_all_around_POSITIVE-CENTER-nowiener128_1_16000.mat', 'r')#large
...
#negative
    ...
    # data1 = h5py.File('Fusion_test_nowiener/DRESDEN_TEST_LARGE_NEGATIVE-CENTER-nowiener64_1_4000.mat', 'r')#large

    data1 = h5py.File('/home/seamus20/matlab_wyl/Fusion_test/DRESDEN_all_around_NEGATIVE-CENTER-nowiener128_1_16000.mat', 'r')#large
...
# #保存权重用于后续ROC曲线绘制
    ...
    save_path = os.path.join(save_folder, 'Dresden_FUSION-nat-nowiener-all-around-128_pce_values.mat')
