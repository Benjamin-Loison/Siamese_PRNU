...
#init_validate_dataset
    ...
    for epoch in rangeepochs:
        ...
        if (epoch + 1) % 25 == 0:
            torch.save(module_fusion.state_dict(),os.path.join(opt.outf, f'ImageFusion-Net*image-norm-epoch{epoch + 1}.pth'))
    ...
    torch.save(module_fusion.state_dict(), os.path.join(opt.outf, 'ImageFusion-Net*image-norm.pth'))
