...
def main():
    ...
    DID_files = sorted(glob.glob(os.path.join('Dresden_others_overlay',  '*.mat')))
    for i in range(5):
    ...
    sio.savemat('Dresden_PCE_dict_128/Proposed_PCE_others1111.mat', {'intra_pce': adnet_intra_pce, 'inter_pce': adnet_inter_pce})

    ADNet_PCE = sio.loadmat('Dresden_PCE_dict_128/Proposed_PCE_others1111.mat')
