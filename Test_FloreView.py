...
#test-dataset
   ...
   #negative
    ...
    # data1 = h5py.File('Fusion_test_nowiener/DRESDEN_lower-left_NEGATIVE-CENTER-nowiener160_1_4000.mat', 'r')  # large
...
#init_validate_dataset
    ...
    module_fusion.load_state_dict(torch.load('Fusion_Weights_FloreView/conv7-se_FloreView_5_0.9244444444444444.pth'))
    #
...
#positive_fusion
    ...
    for i in range(num):
        ...
        # data2 = preprocessing_function(crosscorr2(preprocessing_function(ref_prnu), noise))  # 1和2差距很大
...
#negative_fusion
    ...
    save_folder = "PCE_SAVE_Dresden_Surround_conv7+se_FV"
    if not os.path.exists(save_folder):
        os.makedirs(save_folder)
# #保存权重用于后续ROC曲线绘制
    save_path = os.path.join(save_folder, 'Dresden_PRNU-FV_128_pce_values_upper-left.mat')
    sio.savemat(save_path, {'positive_pce': pos_pce_values,'negative_pce': neg_pce_values})

    save_path = os.path.join(save_folder, 'Dresden_FUSION-nat-FV-128_pce_values_upper-left.mat')
